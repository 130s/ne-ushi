 ...
 * @generated */
public class AbsType_Type extends NamedEntity_Type {
  /** @generated */
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (AbsType_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = AbsType_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new AbsType(addr, AbsType_Type.this);
  			   AbsType_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new AbsType(addr, AbsType_Type.this);
  	  }
    };
  /** @generated */
  public final static int typeIndexID = AbsType.typeIndexID;
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("net.lateeye.uima.types.speech.AbsType");
  ...
  public String getSpeechType(int addr) {
      ...
      jcas.throwFeatMissing("speechType", "net.lateeye.uima.types.speech.AbsType");
  ...
  public String getSpeechSubType(int addr) {
      ...
      jcas.throwFeatMissing("speechSubType", "net.lateeye.uima.types.speech.AbsType");
  ...
  public String getSpeechSubSubType(int addr) {
      ...
      jcas.throwFeatMissing("speechSubSubType", "net.lateeye.uima.types.speech.AbsType");
  ...
  public String getOriginalForm(int addr) {
      ...
      jcas.throwFeatMissing("originalForm", "net.lateeye.uima.types.speech.AbsType");
  ...
  public String getKana(int addr) {
      ...
      jcas.throwFeatMissing("kana", "net.lateeye.uima.types.speech.AbsType");
  ...
  public String getSpeechSubSubSubType(int addr) {
      ...
      jcas.throwFeatMissing("speechSubSubSubType", "net.lateeye.uima.types.speech.AbsType");
  ...
  public String getConjugation_1(int addr) {
      ...
      jcas.throwFeatMissing("conjugation_1", "net.lateeye.uima.types.speech.AbsType");
  ...
  public String getConjugation_2(int addr) {
      ...
      jcas.throwFeatMissing("conjugation_2", "net.lateeye.uima.types.speech.AbsType");
  ...
  public String getPronunciation(int addr) {
      ...
      jcas.throwFeatMissing("pronunciation", "net.lateeye.uima.types.speech.AbsType");
  ...
  /** initialize variables to correspond with Cas Type and Features
	* @generated */
  public AbsType_Type(JCas jcas, Type casType) {
    super(jcas, casType);
